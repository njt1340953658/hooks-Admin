...
import { findAllBreadcrumb, getOpenKeys, handleRouter, searchRoute } from '@/utils/utilTool'
...
const LayoutMenu = () => {
  ...
  const getMenuData = async () => {
    ...
    try {
      const data = [
        { icon: 'HomeOutlined', path: '/home/index', title: '首页' },
        { icon: 'HomeOutlined', path: '/test/index', title: '测试' }
      ] as any
